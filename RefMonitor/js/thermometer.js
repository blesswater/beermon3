var Thermometer = (function(d3) {
	...
	Thermometer.prototype.createMarker = function( name, text, value) {
        ...
        this._svg
            ...
            .attr("y1", this._axisData.scale(value))
            .attr("y2", this._axisData.scale(value))
	...
	function _renderAxis() {
		...
		svgAxis.selectAll(".tick text")
			// .style("fill", "#777777")
			.style("fill", this._config.scaleColor)
		...
		svgAxis.selectAll(".tick line")
			// .style("stroke", this._config.borderColor)
			.style("stroke", this._config.scaleColor)
			.style("shape-rendering", "crispEdges")
			.style("stroke-width", this._config.borderWidth + "px");
	}
