...
** A2D 
*/
#define BEERCHIP_A2D_CHAN0_TEMP_BYTE0    0x10
#define BEERCHIP_A2D_CHAN0_TEMP_BYTE1    0x11
    
#define BEERCHIP_A2D_CHAN0_READING_BYTE0 0x12
#define BEERCHIP_A2D_CHAN0_READING_BYTE1 0x13
#define BEERCHIP_A2D_CHAN0_COUNT_BYTE0   0x14
#define BEERCHIP_A2D_CHAN0_COUNT_BYTE1   0x15
    
#define BEERCHIP_A2D_CHAN1_TEMP_BYTE0    0x16
#define BEERCHIP_A2D_CHAN1_TEMP_BYTE1    0x17
    
#define BEERCHIP_A2D_CHAN1_READING_BYTE0 0x18
#define BEERCHIP_A2D_CHAN1_READING_BYTE1 0x19
#define BEERCHIP_A2D_CHAN1_COUNT_BYTE0   0x1A
#define BEERCHIP_A2D_CHAN1_COUNT_BYTE1   0x1B
