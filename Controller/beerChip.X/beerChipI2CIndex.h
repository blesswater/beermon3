...
#define BEERCHIP_A2D_CHAN2_TEMP_BYTE0    0x22
#define BEERCHIP_A2D_CHAN2_TEMP_BYTE1    0x23
#define BEERCHIP_A2D_CHAN2_READING_BYTE0 0x24
#define BEERCHIP_A2D_CHAN2_READING_BYTE1 0x25
#define BEERCHIP_A2D_CHAN2_COUNT_BYTE0   0x26
#define BEERCHIP_A2D_CHAN2_COUNT_BYTE1   0x27
    
#define BEERCHIP_A2D_CHAN3_TEMP_BYTE0    0x28
#define BEERCHIP_A2D_CHAN3_TEMP_BYTE1    0x29
#define BEERCHIP_A2D_CHAN3_READING_BYTE0 0x2A
#define BEERCHIP_A2D_CHAN3_READING_BYTE1 0x2B
#define BEERCHIP_A2D_CHAN3_COUNT_BYTE0   0x2C
#define BEERCHIP_A2D_CHAN3_COUNT_BYTE1   0x2D
    
/*
** Relays
*/
#define BEERCHIP_RELAY_ENABLE           0x0E
#define BEERCHIP_RELAY_CONTROL          0x0F
